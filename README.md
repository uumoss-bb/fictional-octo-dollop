...
@londelo/pomo_go/0.1.0 darwin-x64 node-v12.16.3
$ pomo --help [COMMAND]
USAGE
  $ pomo COMMAND
...
...
_See code: [src/commands/configure.js](https://github.com/websites/fictional-octo-dollop/blob/v0.1.0/src/commands/configure.js)_
...
_See code: [src/commands/go.js](https://github.com/websites/fictional-octo-dollop/blob/v0.1.0/src/commands/go.js)_
...
_See code: [src/commands/view.js](https://github.com/websites/fictional-octo-dollop/blob/v0.1.0/src/commands/view.js)_
<!-- commandsstop -->
