...
class ConfigureCommand extends Command {
  ...
  async downloadSound() {
    await fs.copy(`${this.rootLocation}/@londelo/pomo_go/src/sounds/mixkit-scanning-sci-fi-alarm-905.wav`, `${this.config.configDir}/mixkit-scanning-sci-fi-alarm-905.wav`)
